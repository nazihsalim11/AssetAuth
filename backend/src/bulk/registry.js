...
const VENDOR = {
  ...
  columns: [
    ...
    { header: 'GST Number', key: 'gstNumber', type: 'string' },
    { header: 'PAN Number', key: 'panNumber', type: 'string' },
    { header: 'Bank Name', key: 'bankName', type: 'string' },
    { header: 'Bank Account Number', key: 'bankAccountNumber', type: 'string' },
    { header: 'IFSC/SWIFT', key: 'bankIfscSwift', type: 'string' },
    { header: 'Account Holder Name', key: 'bankAccountHolder', type: 'string' },
  ...
  sample: {
    ...
    'GST Number': '29ABCDE1234F1Z5', 'PAN Number': 'ABCDE1234F', 'Bank Name': 'HDFC Bank',
    'Bank Account Number': '50100123456789', 'IFSC/SWIFT': 'HDFC0000123',
    'Account Holder Name': 'Dell Commercial Sales Pvt Ltd',
    'Payment Terms': 'Net 30', 'Currency': 'INR',
  },
  toDoc: (r) => ({
    name: r.name, address: orNull(r.address), gst_vat: orNull(r.gstVat),
    gst_number: orNull(r.gstNumber), pan_number: orNull(r.panNumber),
    contact_person: orNull(r.contactPerson), email: orNull(r.email), phone: orNull(r.phone),
    bank_name: orNull(r.bankName), bank_account_number: orNull(r.bankAccountNumber),
    bank_ifsc_swift: orNull(r.bankIfscSwift), bank_account_holder: orNull(r.bankAccountHolder),
  ...
  toExport: (v) => ({
    ...
    'Email': v.email, 'Phone': v.phone, 'GST Number': v.gst_number, 'PAN Number': v.pan_number,
    'Bank Name': v.bank_name, 'Bank Account Number': v.bank_account_number,
    'IFSC/SWIFT': v.bank_ifsc_swift, 'Account Holder Name': v.bank_account_holder,
    'Payment Terms': v.default_payment_terms, 'Currency': v.default_currency,
  }),
};
